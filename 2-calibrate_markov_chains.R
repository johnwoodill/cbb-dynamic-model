...
# dat3 <- data.frame(A = c(12.18, 8.97, 3.50, 1.44, 0.22, 0.10, 0.64, 0.30, 0.66, 0.39),    # A/B Live
#                    B = c(4.62, 1.17, 0.30, 0.21, 0.30, 0.44, 0.80, 0.51, 1.10, 1.43),     # A/B Dead
#                    C = c(4.20, 2.86, 1.20, 1.35, 0.48, 1.46, 2.56, 2.19, 9.24,11.18))     # C/D Position
#                    
# 
# dat4 <- data.frame(A = c(31.82, 26.22, 21.78, 22.20, 19.68, 13.50, 10.56, 8.32, 5.60, 1.80),      # A/B Live
#                    B = c(0.43, 1.52, 0.33, 0.37, 1.64, 1.80, 0.48, 1.04, 0.56, 2.40),                # A/B Dead
#                    C = c(10.75, 8.26, 7.89, 5.43, 10.68, 19.70, 26.96, 34.64, 40.84, 45.80))     # C/D Position
