...
p1 <- ggplot(newdat, aes(month, percent_ab_live)) + geom_line()+ ggtitle("AB LIVE") + scale_x_continuous(breaks = 3:12) 
# +  geom_line(aes(month, percent_ab_live_high), linetype = "dotted")+ geom_line(aes(month, percent_ab_live_low), linetype = "dotted")
p1
p2 <- ggplot(newdat, aes(month, percent_ab_dead)) + geom_line() + ggtitle("AB DEAD")+ scale_x_continuous(breaks = 3:12) 
#+ geom_line(aes(month, percent_ab_dead_high), linetype = "dotted")+ geom_line(aes(month, percent_ab_dead_low), linetype = "dotted")
p2
